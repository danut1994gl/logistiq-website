            ...
            <div className="relative bg-gradient-to-br from-slate-800 to-slate-900 rounded-2xl shadow-2xl overflow-hidden animate-float">
              ...
              <div className="flex items-center gap-2 px-4 py-3 bg-slate-800 border-b border-slate-700">
                ...
                <div className="flex-1 flex justify-center">
                  <div className="w-72 max-w-full px-4 py-1 bg-slate-700 rounded-lg text-slate-400 text-sm flex items-center justify-center gap-2">
                    <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
                    </svg>
                    <span><span className="text-emerald-400">https://</span>logistiq.cloud</span>
                  </div>
                </div>
              </div>
