...
export function FeatureFAQSection({
  ...
  return (
    <section aria-labelledby="feature-faq-title" className="py-16 lg:py-24">
      {schema ? <JsonLd data={schema} /> : null}
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 id="feature-faq-title" className="text-3xl sm:text-4xl font-bold text-slate-900 dark:text-white text-center mb-12">
          {title}
        </h2>
        <FeatureFaqAccordion items={items} />
      </div>
    </section>
  );
}
