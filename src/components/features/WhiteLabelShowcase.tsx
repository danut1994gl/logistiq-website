...
import { UsersIcon, ApiIcon, ChartIcon } from "@/components/icons";
...
// White-Label & gate credentials (feature 8) rich showcase: the driver page
// re-skinning to a customer brand + the real device/gate credentials panel.
// Server Component.
    ...
    <>
      ...
      <FeatureBenefitsSection
        ...
        groups={[
          ...
          { icon: ApiIcon, title: f.b2t, items: [f.b2a, f.b2b, f.b2c] },
